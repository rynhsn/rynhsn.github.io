...
var KTCustomersExport = function () {
    ...
    return {
        init: function () {
            t = document.querySelector("#kt_tanaman_export_modal"), a = new bootstrap.Modal(t), i = document.querySelector("#kt_tanaman_export_form"), e = i.querySelector("#kt_tanaman_export_submit"), n = i.querySelector("#kt_tanaman_export_cancel"), o = t.querySelector("#kt_tanaman_export_close"), r = FormValidation.formValidation(i, {
                    fields: {
                        date: {
                            validators: {
                                notEmpty: {
